...
function the_conference_primary_nagivation( $mobile = false ){ 
    ...
    $schema = $mobile ? '' : ' itemscope itemtype="http://schema.org/SiteNavigationElement"'; 
    ?>
...
function the_conference_breadcrumb(){ 
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) ){
        ...
        if( is_home() ){
            ...
            echo $before .'<a itemprop="item" href="'. esc_url( $request_uri ) .'"><span itemprop="name">'. esc_html__( 'Search Results for "', 'the-conference' ) . esc_html( get_search_query() ) . esc_html__( '"', 'the-conference' ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
            ...
            $depth ++;
            echo $before .'<a itemprop="item" href="' . esc_url( get_day_link( get_the_time( __( 'Y', 'the-conference' ) ), get_the_time( __( 'm', 'the-conference' ) ), get_the_time( __( 'd', 'the-conference' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'd', 'the-conference' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
        
        }elseif( is_month() ){
            $depth = 2;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'the-conference' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'the-conference' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . $delimiter . '</span></span>';
            $depth++;
            echo $before .'<a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'the-conference' ) ), get_the_time( __( 'm', 'the-conference' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'F', 'the-conference' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
        
        }elseif( is_year() ){
            $depth = 2;
            echo $before .'<a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'the-conference' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'Y', 'the-conference' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
